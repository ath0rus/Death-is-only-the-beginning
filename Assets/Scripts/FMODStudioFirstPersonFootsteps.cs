...
public class FMODStudioFirstPersonFootsteps : MonoBehaviour
{
    ...
    void MaterialCheck() // This method when performed will find out what material our player is currenly on top of and will update the value of 'F_MaterialValue' accordingly, to represent that value.
    {
        ...
        {                                                                                                   // Else if however, the player is standing on an object that doesn't have a 'FMODStudioMaterialSetter' script component for our raycast to find...
                F_MaterialValue = DefaultMaterialValue;                                                              // ...we then set 'F_MaterialValue' to match the value of 'DefaultMaterialValue'. 'DefaultMaterialValue' is given a value by the 'FMODStudioFootstepsEditor' script. This value represents whatever material we have selected as our 'DefaultMaterial' in the Unity Inspector tab.
        }
        else                                                                                                         // Else if however, the raycast can't find a collider attached to the object at all...
            F_MaterialValue = DefaultMaterialValue;                                                                  // Then again, we set 'F_MaterialValue' to match the value of 'DefaultMaterialValue'.
    }
